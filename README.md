...
We believe that education unlocks human potential, which means that no matter how many years of experience we have, we should always be learning. For this reason, we provide on-the-job training to our employees. Therefore, every employee of the company must understand the basic concepts of DevOps and the company's development environment.

## Blockchain carrer 
If you are part of the blockchain team, you must understand all the concepts and principles of blockchain. Further, depending on your main role, we may need a deeper understanding. On-the-job training would allow best practices to develop, and then that knowledge would attract good people around you. Moreover, our program allows new developers to learn new technology as a shortcut. This makes us more competitive than other companies. Think of us as always at the forefront of our market. Your rewards will be the pride of your family and your lovely people

Detail content as below.
...
|  [Geth Package Analysis : state, trie, internal/ethapi, rawdb, ethdb - Jason](https://docs.google.com/presentation/d/1_9TZJEB--JmaU4T78If_vwvNcKls2vBUVnXqZqkUylQ)   |  core |  seminar, one-paper  |    |
|  [Geth Package Analysis : cmd/geth - Thomas](https://drive.google.com/open?id=1WFaWG3DRrKES6YrhFyLIvumn8PuLarmw55jek_8vzuo)   |  core |  seminar, one-paper  |    |
|  [Geth Package Analysis : /eth, /core, /core/vm - Thomas](https://docs.google.com/presentation/d/1UE4mMz7395pZmVOhFecnNv33AN0sGaNsmyr0hB2uNDs)   |  core |  seminar, one-paper  |    |
|  [Geth Package Analysis : /miner, /worker - Thomas](https://drive.google.com/open?id=1rQngQ0d6GaFMuxTCW5gZ2O12MZpqZzx9UpLcle9I6XQ)   |  core |  seminar, one-paper  |    |
|  [Geth Package Analysis : p2p Layer - Thomas](https://drive.google.com/open?id=1GmdQjJoomJcaSc9vu3e4DVo9iLSow1vAqzUKtHZUAbM)   |  core |  seminar, one-paper  |    |
|  [Geth Package Analysis : Txpool - Thomas](https://drive.google.com/open?id=1MYcwJOyi_FbAVufuEu___gvTmLuGcm_7jD7MZMG0KsY)   |  core |  seminar, one-paper  |    |
|  [Geth Package Analysis : params, core/vm, ethdb, trie - Jake](https://docs.google.com/presentation/d/1DUqRdXDYNWnGcJsvN3M-0Ll8BJ09ZroSYl5BCh7yMt0)   |  core |  seminar, one-paper  |    |
|  [Geth Package Analysis : fetcher, downloader, rawdb, ethdb - Jin](https://drive.google.com/open?id=1Wtv_BoYGeM6ocA3XsP-6JINkzW1ETOSvOdKjavkJpjc)   |  core |  seminar, one-paper  |    |
...
|  [Cross Shard Communication -1- Asynchronous Communication](https://medium.com/onther-tech/%EC%9D%B4%EB%8D%94%EB%A6%AC%EC%9B%802-0-%EA%B9%8A%EC%9D%B4%EB%B3%B4%EA%B8%B0-%EC%8B%9C%EB%A6%AC%EC%A6%88-cross-shard-communication-async-2%ED%8E%B8-ac78e921e8a4)   |  core, smart-contract |  one-paper  |    |
|  [Cross Shard Communication -2- Synchronous Communication](https://medium.com/onther-tech/%EC%9D%B4%EB%8D%94%EB%A6%AC%EC%9B%802-0-%EA%B9%8A%EC%9D%B4%EB%B3%B4%EA%B8%B0-%EC%8B%9C%EB%A6%AC%EC%A6%88-cross-shard-communication-sync-3%ED%8E%B8-cbff047e8f0d)   |  core, smart-contract |  one-paper  |    |
